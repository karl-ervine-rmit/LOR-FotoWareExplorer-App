  ...
  return (
    <div className="space-y-6">
      <section className="text-center py-12 border-b">
        <h1 className="text-4xl font-bold mb-4">Learning Objects Repository</h1>
        <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
          Welcome to RMIT’s Learning Objects Repository — a searchable platform
          to find, preview, and organise educational media, all in one place.
        </p>
          ...
          <div className="flex justify-center">
            ...
            >
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="lucide lucide-shuffle h-4 w-4 mr-2"
              >
      ...
      <section className="mb-8">
        ...
        >
          <svg
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            className="lucide lucide-circle-alert h-4 w-4 absolute left-4 top-4 text-foreground"
          >
          ...
          <div className="text-sm pl-7">
            FotoWare API credentials are required to load archives and assets.
            The application is ready but needs your FotoWare server URL and API
            token to display data.
          </div>
        </div>
      </section>
        ...
        {archives.length === 0 ? (
          <div className="rounded-lg border bg-card text-card-foreground shadow-sm p-12 text-center">
            <svg
              ...
              strokeLinecap="round"
              strokeLinejoin="round"
              className="lucide lucide-archive h-12 w-12 text-muted-foreground mx-auto mb-4"
            >
            ...
            <p className="text-muted-foreground mb-4">
              No digital asset archives are currently available.
            </p>
          ...
          <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            {archives.map((archive) => (
              <li
                key={archive.id}
                className="border rounded-lg p-6 bg-white dark:bg-gray-900 shadow hover:shadow-lg transition"
              >
                <Link
                ...
                >
                  ...
                  <span className="inline-block mt-4 text-primary underline">
                    View archive
                  </span>
                </Link>
              </li>
